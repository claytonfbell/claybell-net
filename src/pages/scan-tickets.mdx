...
![scanning a ticket](../images/scan-tickets/ticket.jpeg)
...
The iOS version is primarily for iPods that are inserted into [barcode scanner accessory](https://ipcmobile.com/devices/linea-pro-5) that encases the iPod, but some smaller events may use iPhones with the camera to scan tickets.
